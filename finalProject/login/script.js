...
revealPasswordButton.addEventListener("click", function(event) {
    ...
    if (passwordIsRevealed == false) {
        ...
        inputs[1].parentNode.querySelector("button").classList.remove("btn-danger")
        inputs[1].parentNode.querySelector("button").classList.add("btn-success")
        inputs[1].parentNode.querySelector("button").innerHTML = `
        ...
        inputs[1].parentNode.querySelector("button").classList.remove("btn-success")
        inputs[1].parentNode.querySelector("button").classList.add("btn-danger")
        inputs[1].parentNode.querySelector("button").innerHTML = `
